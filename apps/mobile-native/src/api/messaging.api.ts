...
export async function listMessages(conversationId: string, opts: { cursor?: string; limit?: number } = {}) {
...
export async function sendMessageRest(conversationId: string, body: Omit<SendMessageDto, 'conversationId'>) {
...
export async function markConversationRead(conversationId: string, lastReadAt?: Date): Promise<void> {
