...
export async function updateCommunity(id: string, dto: UpdateCommunityDto): Promise<CommunityDetail> {
...
export async function respondCommunityJoin(id: string, dto: Omit<RespondCommunityJoinDto, 'communityId'>) {
