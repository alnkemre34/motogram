    ...
    <SafeAreaView style={styles.root} edges={['top', 'left', 'right']}>
      <View style={styles.header}>
        ...
        <View style={styles.headerActions}>
          <Pressable
            onPress={() => rootNav?.navigate('Inbox')}
      ...
      <FlatList
        ...
        ListEmptyComponent={<Text style={styles.empty}>{t('home.emptyFeed')}</Text>}
        renderItem={({ item }) => {
          ...
          return (
            <View style={styles.postCard}>
              ...
              <View style={styles.actions}>
                <Pressable onPress={() => like.mutate({ postId: item.id, currentlyLiked: item.likedByMe })}>
