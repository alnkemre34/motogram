      ...
      >
        ...
        {party ? (
          <View style={styles.activeCard}>
            ...
            <Pressable onPress={onJumpToMap} style={({ pressed }) => [styles.primaryBtn, pressed && styles.pressed]}>
        ...
        {loading ? (
          ...
          invites.map((inv) => (
            <View key={inv.id} style={styles.inviteCard}>
              <Text style={styles.inviteFrom}>{t('inbox.partyInviteFrom', { id: inv.inviterId.slice(0, 8) })}</Text>
              <Text style={styles.inviteParty}>{t('inbox.partyInviteParty', { id: inv.partyId.slice(0, 8) })}</Text>
