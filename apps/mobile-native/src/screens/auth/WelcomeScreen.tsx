  ...
  return (
    <View style={styles.root}>
      ...
      <View style={styles.actions}>
        <Pressable style={[styles.button, styles.primary]} onPress={() => navigation.navigate('Login')}>
          <Text style={styles.buttonPrimaryText}>{t('auth.welcome.ctaLogin')}</Text>
        </Pressable>
        <Pressable style={[styles.button, styles.secondary]} onPress={() => navigation.navigate('Register')}>
