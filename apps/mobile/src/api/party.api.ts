...
// Spec 3.5 - REST for party lifecycle (Socket.IO sadece real-time events icin)
...
export async function listNearbyParties(params: {
  ...
  if (params.radiusMeters) search.set('radiusMeters', String(params.radiusMeters));
...
/** Sunucu dogrudan dizi doner (`PartyInvitesMineResponseSchema`). */
