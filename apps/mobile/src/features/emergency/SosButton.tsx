...
// Spec 2.3.2 + 4.4 - SOS butonu.
// - 3sn basili tut: ring animasyonu + heavy haptic'ler her saniye.
// - Release <3sn: iptal + uyari haptic.
// - 3sn tamamlandi: API'ye POST ve confirm success haptic.
// - Cooldown 30sn: ayni butona cift basmayi onler (Spec 4.4 false-tap).
