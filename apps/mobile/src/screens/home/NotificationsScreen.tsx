    ...
    <SafeAreaView style={styles.root} edges={['top', 'left', 'right']}>
      ...
      {!q.isLoading && !q.isError ? (
        <FlatList
          ...
          ListEmptyComponent={
            <Text style={styles.mutedCenter}>{t('home.notificationsEmpty')}</Text>
          }
          renderItem={({ item }) => (
            <View
...
const styles = StyleSheet.create({
  ...
  retry: { marginTop: 12, paddingHorizontal: 20, paddingVertical: 8, borderRadius: 8, backgroundColor: '#1a1a1a' },
